...
export const CityBackground = () => {
  ...
  const skylineY = useTransform(scrollY, [0, 4000], [0, -180]);
  const glow1Y   = useTransform(scrollY, [0, 4000], [0, -100]);
  const glow2Y   = useTransform(scrollY, [0, 4000], [0, -60]);
  const glow3Y   = useTransform(scrollY, [0, 4000], [0, -140]);
