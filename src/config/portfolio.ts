...
Alongside an MSc in Data Science in Berlin, I keep building my own projects — mostly because each one started as a problem I had.`,
  ...
  projects: [
    ...
    {
      title: 'RoomSplit',
      subtitle: 'Shared-household finances, actually settled',
      emoji: '🏠',
      featured: false,
      description: `A full-stack platform for shared households — expenses, OCR-parsed receipts, debt settlement, chores, and a shared grocery list, in one place instead of five group chats.`,
      technologies: ['Next.js', 'TypeScript', 'PostgreSQL', 'Prisma', 'AWS S3'],
      features: [
        'OCR receipt parsing and recurring-expense automation',
        'Debt simplification and settlement tracking',
        'Chore assignment, shopping list, and grocery prediction',
        'Dashboard analytics and real-time notifications',
      ],
      githubUrl: 'https://github.com/sidddharthhahir/roomsplit',
      metrics: '📅 Feb 2026',
      caseStudy: {
        problem: 'Splitting a household’s money, chores, and groceries usually ends up scattered across spreadsheets and chat threads that nobody trusts.',
        approach: 'One schema for expenses, debts, and chores, with OCR to kill manual receipt entry and automation for the recurring stuff.',
        results: 'Balances, chores, and shared shopping tracked in one place, with typed, tested settlement logic.',
      },
    },
  ],
